...
There are 21 numeric variables per observation in the data. Each observation is classified in one of 9 categories: Breakfast, Beef & Pork, Chicken & Fish, Salads, Snacks & Sides, Desserts, Beverages, Coffee & Tea, Smoothies & Shakes.

Run a dimensionality reduction algorithm on the data, and visualize the new dimensions with `category` as the categorical variable. Based on your visualization, try to explain how these categories are grouped together. How are they similar or different?
...
This barplot shows the distributions of levels of blood pressure people whether who have the cardiovascular disease or not. For hypertension, people don't have the disease more than having the disease. For hypertension crisis, it is hard to observe because the proportion of hypertension crisis is 0.18% (127/68651). For stage s hypertension, people having the disease are more than people not having the disease.
